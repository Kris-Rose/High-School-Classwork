...
public class Simulator
{
    ...
    /**
     * Run the simulation from its current state for a s    ingle step.
    ...
    private void populate()
    {
        ...
        for(int r = 0; r<DEFAULT_WIDTH; r++){
            for(int c = 0; c< DEFAULT_DEPTH; c++){
                if(a.nextDouble() < FOX_CREATION_PROBABILITY){
                    new Fox(field, new Location(r,c));  
                }
            }
        }
        ...
        for(int r = 0; r<DEFAULT_WIDTH; r++){
            for(int c = 0; c< DEFAULT_DEPTH; c++){
                if(field.getObjectAt(r, c) == null){
                    if(a.nextDouble() < RABBIT_CREATION_PROBABILITY){
                        new Rabbit(field, new Location(r,c));                                                                                                                                                          
                    }
                }
            }
        }
